...
\begin{figure}[!htb]
	...
	\caption{Normalized sensor averaged per gas. Each line corresponds to an unique mixture. The levels are the concentrations of individual components of the mixture: (a) NO (b) \ch{NO2}, and (c) \ch{NH3}}
