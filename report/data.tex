...
Finally, the majority of models proposed are scale variant, with the exception of \acrshort{ols}. The data, therefore, was centered and scaled to have unit variance and zero mean. A snippet of the final data set is shown in Table~\ref{tab:prepro-sample}. Moreover, in Figures~\ref{fig:slopes} and ~\ref{fig:averages}, slopes and averages were plotted through time, i.e. the 240 measurement windows.
