...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{../figures/feat-naming.pdf}
...
\begin{table}[h]
	\centering
	\caption{Sample of averaged features throughout all exposures data. Note that the slope columns were discarded.}
